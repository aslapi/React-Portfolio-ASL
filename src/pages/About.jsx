export default function About() {
    return (
        <div className="text-center m-5">
            <h1>About</h1>
            <p className="p-5 fs-5">My name is <b className="fs-3">Alex LaPierre</b>, I'm a student at the University of Minnesota Coding Bootcamp.
                I'm learning full stack web development and am eager to showcase my skills. I'm currently employed
